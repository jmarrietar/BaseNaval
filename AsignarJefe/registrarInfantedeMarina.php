...
<body>
<form class="form-horizontal" id="registraInfantedeMarina" method='get' action ='../Registrar/registrarInfantedeMarina.php'   >
 ...
 <div class="control-group">
	 ...
	 <select id="tipo1" name='tipo'><br/>
       ...
       <div class="form-actions">
        ...
        <input type="button"  onclick="validarmodulo()" value='pepito'>
